...
public class HPLatestCampaignManager extends BasePage {
	...
	void setupRender() {
		hpBlock = hpBlockService.findUniqueBy("name", HPBlockEnum.LATEST_CAMPAIGN.name());
	...
	public BeanModel<HPBlockContent> getBeanModel() {
		...
		beanModel.include("sequence", "cdata", "url", "image", "description");
		return beanModel;
	}
