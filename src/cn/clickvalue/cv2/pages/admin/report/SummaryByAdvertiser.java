...
public class SummaryByAdvertiser extends BasePage {

	@Component(parameters = { "value=userName", "event=blur" })
	@Mixins(value = { "autoCompleteExt", "commons/OnEvent" })
	...
	@OnEvent(component = "textField1", value = "blur")
	public void onBlurFromTextField1(String value) {
		siteList = siteService.getAffiliatedSite(value);
		campaignList = campaignService.getCampaignByUserName(value);
	}

	List<Object[]> onProvideCompletionsFromTextField1(String partial) {
		List users = reportSummaryService.findUsersByRole(Constants.USER_GROUP_ADVERTISER, partial);
	...
	private void queryReport() {
		this.dataSource = new ReportDataSource(reportSummaryService.findReportList(dateBegin, dateEnd, Constants.USER_GROUP_ADVERTISER,
				...
				reportSummaryService.reportCount(dateBegin, dateEnd, Constants.USER_GROUP_ADVERTISER, userName, campaignId, siteId,
						getReportType(), getFilter()));
	}

	private void total() {
		List<Report> total = reportSummaryService.findReportList(dateBegin, dateEnd, Constants.USER_GROUP_ADVERTISER, userName, campaignId,
	...
	public BeanModel<Report> getBeanModel() {
		...
		beanModel.include("sumCpcCountOld", "sumCpcSitecommisionOld", "sumCplCountOld", "sumCplSitecommisionOld", "sumCpsCountOld", "sumCpmCountOld",
				"sumCpmSitecommisionOld", "sumCpsSitecommisionOld", "sumDarwcommisionTotalOld", "sumSitecommisionTotalOld", "totalCommisionOld");
	...
	void OnSubmitFromExport() throws WriteException, IOException {
		...
		List<Report> datas = reportSummaryService.findReportList(dateBegin, dateEnd, Constants.USER_GROUP_ADVERTISER, userName, campaignId,
