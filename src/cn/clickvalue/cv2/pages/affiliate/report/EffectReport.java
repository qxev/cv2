...
public class EffectReport extends BasePage {
    ...
    @SetupRender
    void setupRender() {
        siteList = siteService.getSiteByUserId(getClientSession().getId());
        campaignList = campaignService.getCampaignsByAffiliate(getClientSession()
                .getId());
        queryReport();
        total();
    }
    ...
    public BeanModel<Report> getBeanModel() {
        ...
        beanModel.get("sumCpmSitecommisionOld").label("CPM"+getMessages().get("commission")).sortable(true);
        beanModel.get("sumCpcCountOld").label(getMessages().get("clicks")).sortable(true);
        beanModel.get("sumCpcSitecommisionOld").label("CPC"+getMessages().get("commission")).sortable(true);
        beanModel.get("sumCplCountOld").label(getMessages().get("leads")).sortable(true);
        beanModel.get("sumCplSitecommisionOld").label("CPL"+getMessages().get("commission")).sortable(true);
        beanModel.get("sumCpsCountOld").label(getMessages().get("sales")).sortable(true);
        beanModel.get("sumCpsSitecommisionOld").label("CPS"+getMessages().get("commission")).sortable(true);
        beanModel.get("sumSitecommisionTotalOld").label(getMessages().get("total_commission")).sortable(true);
        
        beanModel.include("sumCpmCountOld", "sumCpmSitecommisionOld",
        		"sumCpcCountOld", "sumCpcSitecommisionOld",
        		"sumCplCountOld", "sumCplSitecommisionOld", 
        		"sumCpsCountOld", "sumCpsSitecommisionOld", "sumSitecommisionTotalOld");
          ...
          if(isBothFilter()) {
              ...
              if(campaignId == null && siteId == null) {
                  ...
                  if(isCampaignFilter()) {
                      ...
                      beanModel.add("siteName").label(getMessages().get("website")).sortable(false);
                      beanModel.add("siteUrl").label("URL").sortable(false);
                      beanModel.reorder("summaryDate","siteName","siteUrl","sumCpcCountOld", 
                              "sumCpcSitecommisionOld","sumCplCountOld", 
                              "sumCplSitecommisionOld", "sumCpsCountOld", 
                              "sumCpsSitecommisionOld",
                              "sumSitecommisionTotalOld");
                  }else {
                      beanModel.add("siteName").label(getMessages().get("website")).sortable(false);
                      beanModel.add("siteUrl").label("URL").sortable(false);
            ...
            if(isBothFilter()) {
                ...
                if(campaignId == null && siteId == null) {
                    if(isCampaignFilter()) {
                        ...
                        beanModel.reorder("sumCpmCountOld", "sumCpmSitecommisionOld",
                        		"sumCpcCountOld", "sumCpcSitecommisionOld",
                        		"sumCplCountOld", "sumCplSitecommisionOld", 
                        		"sumCpsCountOld", "sumCpsSitecommisionOld", 
                        		"sumSitecommisionTotalOld");
