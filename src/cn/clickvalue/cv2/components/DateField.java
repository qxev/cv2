 ...
 */
@IncludeStylesheet("${commons.scripts}/datepicker/datepicker.css")
@IncludeJavaScriptLibrary({"${commons.scripts}/datepicker/datepicker.js",
        "${commons.scripts}/prototype-base-extensions.js",
        "${commons.scripts}/prototype-date-extensions.js"})
public class DateField extends AbstractField
{
    ...
    @Parameter(defaultPrefix = BindingConstants.ASSET, value = "classpath:org/apache/tapestry/commons/jslibs/scripts/datepicker/calendar.png")
    private Asset icon;
