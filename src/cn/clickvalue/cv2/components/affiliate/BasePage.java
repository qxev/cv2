...
public class BasePage {
	 ...
	 *            格式化參數
	 */
	protected void addError(Form form, Field field, String message,
	 ...
	 *            格式化參數
	 */
	protected void addError(Form form, String message, boolean flag,
			Object... args) {
		if (form == null) {
			return;
		}
	...
	private String buildMessage(String key, boolean flag, Object... args) {
		return (flag == true ? getMessageText(key, args) : String.format(key,
				args));
	}
