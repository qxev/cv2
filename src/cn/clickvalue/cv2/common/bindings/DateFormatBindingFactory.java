...
public class DateFormatBindingFactory implements BindingFactory {
	private final BindingSource bindingSource;

	public DateFormatBindingFactory(BindingSource source) {
	...
	public Binding newBinding(String description, ComponentResources container,
		...
		return new DateFormatBinding(location, invariant, b_key, b_value);
	}
