...
public class IPSeeker {
	...
	private static final String IPDATE_FILE_PATH = ConfigReader.appRootDir;

	private static final String IPDATE_FILE = "/IPDate/QQWry.Dat";
	...
	public IPSeeker() {
		...
		try {
			...
			String filename = new File(IPDATE_FILE_PATH + IPDATE_FILE)
					.getName().toLowerCase();
...
//		System.out.println(new IPSeeker().getCountry("202.111.211.65"));
	}
}
