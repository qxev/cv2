...
public class JSONObject {
	...
	public JSONObject accumulate(String key, Object value) {
		...
		// Replace the existing value, of any type, with an array that includes
		// both the
	 ...
	 * @param key
	 *            A key string.
	 * @return The numeric value. @ if the key is not found or if the value is
	 *         not a Number object and cannot be converted to a number.
	 */
	 ...
	 * @param key
	 *            A key string.
	 * @return The integer value. @ if the key is not found or if the value
	 ...
	 * @param key
	 *            A key string.
	 * @return The long value. @ if the key is not found or if the value cannot
	...
	/**
	 * Get an enumeration of the keys of the JSONObject. Caution: the set should
	 * not be modified.
	 * 
	...
	private static final Class[] ALLOWED = new Class[] { String.class,
			Boolean.class, Number.class, JSONObject.class, JSONArray.class,
			Null.class };
	 ...
	 * then null will be returned instead. <p/> Warning: This method assumes
	 ...
	 * properties matches this object's properties. <p/> '
	 */
	@Override
