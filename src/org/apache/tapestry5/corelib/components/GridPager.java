...
public class GridPager
{
    ...
    void beginRender(MarkupWriter writer)
    {
        ...
        writer.element("div", "class", "left");
        
        writePaginationGeneral(writer,availableRows);
        
        writer.end();
        
        writer.element("div", "class", "right");
    ...
    private void writePaginationGeneral(MarkupWriter writer,int availableRows){
    	 writer.element("span");
         writer.write(messages.format("pagination-general",availableRows,(currentPage-1)*rowsPerPage+1,currentPage == maxPages ? availableRows : currentPage*rowsPerPage));
         writer.end();
    }
}
