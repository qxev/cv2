 ...
 * 3. 刷新页面
 *
 * last-update 2008-08-08 updated by Tim
 */
...
var text_province = document.getElementById('textfield_2');
var text_city = document.getElementById('textfield_3');

for(var i=0;i<province.length;i++){
	if(province.options[i].value == text_province.value){
...
for(var i=0;i<city.length;i++){
	if(city.options[i].value == text_city.value){
		city.options[i].selected = true;
	}
}
}

window.onload = function(){pc_init();setSelected();};